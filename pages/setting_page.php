    ...
    <div class="body container-fluid d-flex align-items-center ">
        <div class="body-container container p-2">
            ...
            <div class="d-flex flex-nowrap">
                <nav id="navigation" class="col-md-3 d-md-block col-lg-2 navbar navbar-nav navbar-light Radius">
                    <div class="d-flex flex-column px-2">
                        ...
                        <div class="px-0 offcanvas-body">
                            <div>
                                <input class="filters form-control me-2 my-2" type="search" placeholder="Search"
                                    aria-label="Search" />
                                <div class="accordion" id="accordionExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show mx-auto"
                ...
                <div id="Sections" class="col-lg-10 col-md-9 container carousel slide  pointer-event Radius"
                                    ...
                                    <div class="row Scontainer d-flex">
                                        <div class="offset-md-1 col-12 col-md-5 S1 dis inactive">
                                            ...
                                            <div class="col-12 dp my-5">
                                                ...
                                                <input type="text" name="Enable" placeholder="Enable"
                                                    class="txts txtRouter col-12 r-enable" required>
                                            </div>
                                            <div class="col-12 dp my-5">
                                                <label class="label col-12"> Welcoming massage:</label>
                                                <input type="text" name="WelcomingMassage" placeholder="Welcoming massage"
                                                    class="txts txtRouter col-12 r-massage" required>
                                            </div>
                                            <div class="col-12 dp my-5">
                                                <label class="label col-12"> Console Password:</label>
                                                <input type="text" name="ConsolePassword" placeholder="Console Password"
                                                    class="txts txtRouter col-12 r-console" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-5 S2 dis">
                                            <div class="col-12 dp my-5 abs">
                                                ...
                                                <input type="text" name="TalentPassword" placeholder="Telnet Password"
                                                    class="txts txtRouter col-12 r-telnet" required>
                                            </div>
                                            <div class="col-12 dp my-5">
                                                <label class="label ">Interface Loopback:</label>
                                                <input type="text" name="Interface" placeholder="Interface"
                                                    class="txts txtRouter col-12 r-loopback" required>
                                            </div>
                                            <div class="col-12 dp my-5">
                                                <label class="label col-12">Mask:</label>
                                                <input type="text" name="mask" placeholder="Mask"
                                                    class="txts txtRouter col-12 r-mask" required>
                                            </div>
                                            <div class="col-12 dp my-5">
                                                <label class="label col-12">IP:</label>
                                                <input type="text" name="IP" placeholder="IP"
                                                    class="txts txtRouter col-12 r-ip" required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row Scontainer  d-flex ">
                                    <div class="offset-md-1 col-12 col-md-5 S1 dis inactive">
                                        <div class="col-12 dp my-5 abs">
                                            <label class="label col-12"> Hostname:</label>
                                            <input type="text" name="Hostname" placeholder="Hostname"
                                                class="txts txtSwitch col-12" required>
                                        </div>
                                        <div class="col-12 dp my-5">
                                            <label class="label col-12"> Enable:</label>
                                            <input type="text" name="Enable" placeholder="Enable"
                                    ...
                                    <div class="col-12 col-md-5 S2 dis">
                                        <div class="col-12 dp my-5 abs">
                                            <label class="label col-12"> Telnet Password:</label>
                                            <input type="text" name="TalentPassword" placeholder="Talent Password"
                                                class="txts txtSwitch col-12" required>
                                        </div>
                                        <div class="col-12 dp my-5">
                                            <label class="label col-12">Interface Vlan:</label>
                                            <input type="text" name="Interface-vlan" placeholder="Interface"
                                                class="txts txtSwitch col-12" required>
                                        </div>
                                        <div class="col-12 dp my-5">
                                            <label class="label col-12">Mask:</label>
                                        ...
                                        <div class="col-12 dp my-5">
                                            <label class="label col-12">IP:</label>
                                            <input type="text" name="IP" placeholder="IP" class="txts txtSwitch col-12"
                                                required>
                                        </div>
                                    </div>
                                </div>
